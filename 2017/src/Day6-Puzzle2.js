...
//Runs redistribution pattern until a repeat is found
//Returns size of loop (iterations between repeated distribution)
//NOTE: Identical to Puzzle 1 except for the return statement
function redistributeDiff(input) {
	...
	return (times - rounds.indexOf(thisRoundString)); //Space between this round (times) and the first appearance of the pattern
}
