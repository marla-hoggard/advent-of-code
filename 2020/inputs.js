...
1766
1407`;
const DAY2 = `6-10 p: ctpppjmdpppppp
...
..#....##..#.##.......#.#.#..#.
..#..#........#...#.......#....`;
const DAY4 = `ecl:hzl byr:1926 iyr:2010
...
inchptudjzxelrk
dhiegazkptvqxmrucnj`;
const DAY7 = `striped beige bags contain 5 dull beige bags.
...
51
22`;
const DAY11 = `LLLLLL.LLLL..LLLLLL.LLLLLLLLLLLLLLLLLLLLL.LLLLLL.LLLLLLLL.LLLLL.LLLLLL.L.LL.LLLLLL.LLLLLLLLLLLLLLLL
...
const DAY14 = `mask = 0010011010X1000100X101011X10010X1010
mem[57319] = 8001842
mem[29943] = 1246
mem[3087] = 1055661079
...
mem[43617] = 84114
mem[37229] = 58103`;
const DAY15 = `9,6,0,10,18,2,1`;
const DAY16 = `departure location: 42-322 or 347-954
...
.......#
.#..#..#`;
const DAY18 = `3 * (2 + (9 * 2 * 2 + 8) * (7 * 6 * 7 * 3) * (3 * 9 * 7) * (6 * 6)) * 9 * 8 + 6
...
7
8`;
const DAY23 = '219748365';
const DAY24 = `wenwwsenwwwwnwwnwwwnwsewseewe
