...
14x3x5
10x9x8`;
const DAY3 = `>^^v^<>v<<<v<v^>>v^^^<v<>^^><^<<^vv>>>^<<^>><vv<<v^<^^><>>><>v<><>^^<^^^<><>>vv>vv>v<<^>v<>^>v<v^<>v>><>^v<<<<v^vv^><v>v^>>>vv>v^^^<^^<>>v<^^v<>^<vv^^<^><<>^>><^<>>><><vv><>v<<<><><>v><<>^^^^v>>^>^<v<<vv^^<v<^<^>^^v^^^^^v<><^v><<><^v^>v<<>^<>^^v^<>v<v^>v>^^<vv^v><^<>^v<><^><v^><><><<<<>^vv^>^vvvvv><><^<vv^v^v>v<<^<^^v^<>^<vv><v<v^v<<v<<^^>>^^^v^>v<><^vv<<^<>v<v><><v^^><v<>^^>^^>v^>^<<<<v><v<<>v><^v>^>><v^^<^>v<vvvv<>>>>>^v^^>v<v<^<vv>^>^vv^>vv^^v<<^<^^<>v>vv^v>><>>>v^>^>^^v<>^<v<<>^vv>v^<<v>v<<><v>^vvv<v<vvv^v<vv<v^^^>v><<^<>><v^^>^v^>>^v<^<><v<>>v^<>>v<>>v^^^><^>>vvvv>^v<^><<>>^<>^>vv><v<<>>^^>v^^^><^<<^^v>v<^<<>v>^^vvv^v^>v^<>^^<>v^v>v>v<v^>vv>^^v<>v>>^<>><>v>v^<<vvvv<vvv><v^<^>^v<>>^><v>><>^<v>v<v>vv^>>vvv<>v>v<v^>>^>>v<<>^<>^<>>>^v<<<^<^v>vv^>><<><v^>^v^^^v<>^^vv><>><>>^>v^<v<>v<>>^<<^v>^^^<>^v^><>v<<v>vv^>vv<<>>><<^v^<>v<vv>>>^^<>^><<^>vv>>^<<v^^vv<>>><v>v><^<v<<>>>^^<>>^<^v><>vv^^^v>vvv>^><<>^^>^<<v^<v<^v<<>vvv<^<<>^>^v<vv<^>vvv>v>vv^<v^><>>^vv<^^^vv><^vv<v^<><v^vvv><<^>^^><v<<vv^>v<vv<v>^<>^v<<>v<v^v^>^>^>v<<^vvv<<<v>^^>^<<<<>vv>>^<>^>>>v<v>^^<v^<v<>>>vv>^^v<<>>>^^v><<<v<v<^v<>^^><v<^v<<v^><><^<><v<^^v>>><v^^v<<v^><^<><<v^>><^<>v>v^<><^<v>^v^>^>^vv^>^^<<vv^>vv<^vvv<>>^^<^>v^>^>^<v^><v<v>>>v<<<><^v<<><^<vv^v^^^>v<^^<v^vvv<v<><v<vv<^vv<>vv<v^<>>vvvvv<<>^v^v>vv>>>vvv^^<^<^<><>v<v>><^v><^<<<>><<<v>^>v<>^>^v>>^<>v^<^>><<>^<v>^>^^^>^^<v>>>><>^v^v><<<<vv^<vv<>vv>v<>v^<v^>v><>>>v^<><^vvv>vv^<^<<^<^^v>^>>>v<^<^v^^<^<^>>><v>vv>^<<><>^>>v>^<<>><^<>v<>vv^^>^>vvv^v<<^<^^<vv<>^vvv<^^v^vv^>>v<^>^^<v^<>v<^<^vv>v<<vv>vv>^>vvv>>>^^>v<>^v>v^<^>>v>^^v>>>>v^<v>v<^>v<v<<>>^v<^^<v><^<>>^<<vv^>>v<<v>^v<>><^>vv<v<^>>^^<vvvvvvvvv>>>v<v<>v^<>>^vv<v^^v<<^vvv^<<^><>vv<><<>>v>vv^><>>^^v^>>v^v^><<<>>^^<^v<<^<>>>>^<^>v^><<^>v<^v<^>>^^<<<<><^<^v^v<>>^v<^<<vv^<><^^vv><v^v^v>^>>^>^vv^>^v<v^v<<vvv^><>>^v^^><>v>vv><^>>vv<vvv<<<<^<>vvv^v<v>^<v<^>^<^<v<><>v^^^^<<vv<^^vv<v>><<v^><>>><v^>^v><^>^><vv^<><^<v>><<^vv<>>v^<<v<>v><v<><><vv>^>>v^<^<v>^><>>><^><v^v<>>>^^<^>v<v>vvv<>^<<><v^^>^>>v<^v>^>v>>>vv>v>>v^^^<^<vvv^<>^>^<v^<v^v>v>^>vv>vvv<>v<^>v>^^>>^<vv^^v>v^^^^^v^vv><^<><>^>vv<^>>^vvvv^^^>^<vv>^v<<^><^^>^<>^^>^<<v<^>>>^><<^^>v^v>>^>vvvv>^^v><v>>vv><<<vv<^>v>^^^<v>v^vvv<^><<^>^<>^><<<<<v^<<vv^v>^<>v<v>^>^>><>v^v<^vv^^>vv<<v^v>vv^vvv<<<<>^v<v^^v^v>v<<v>^^<>^vv^^>^>^v^vv^>>v^vv^^<vv><<v^v^^v><vv<^vvv<vv^^<<v>v^v^^^^v<^<^>v>^>v>^vv^v^^<v<^vvvv<<<>^<^^^<^^<>^<><vv<^^<<^>>><v^vvvv>^<>>^^>v^^v^<<v^^^<<<><^<v^v^^v<v^<>v><<v<>^v>v<^><^>vv^^<vvv<^v>>v>^<><v^><^^^<v^>>vv<<<<<^<>^v^v>^vv^<>v>v<^>vv<<^vv>vv<v<><>>v>><v<^<^^>><<v^v<<^><v<^<vv<v<<vv^>^<<><^^>^<^>>^<vv>><v<<vvv<^^v^>^^<^v>^v<v<>v><v^v^<<^<><<v<<^v>v<<>>^>v>>v>>v<^<<^<^>>>v>^^^v><^>^^>>v<<>^v><v>vvv^vv<<<>vvv<<>^>>>v<v<v^<^<^>^<^>v^^v<^^<v<>v<>>^^>^v^>v<<<<^<>v^><<<v>>>><<v^<^vv>v>><>>^<<<^<^^>v<>>v<>vv<<^<<><<^>v^^^vv^>vvvv>>v>v^><<v<>vv^<<><<vvv>^>>>^<<<^<^<<v>^>v<>>v>>vv^^><<<<^^^v>><<^><v><v^^><v<<v^^v^^v>>v<><><<>^><v><^<vv>><^v<>v<vvv<>^>><v>>v<^><<v>^<>^v><^><^^<v>^><^^v^<<><>>^>v^<^v^vv<><^>vv^>v^vvv^<>>^><^<^<>^<<v^v<^v><>^v<v>>^>>^v^vv>><vv><v^^<<^v^<>^v<<>^><^>><v>>v<<<v^^vv<>^^v>>><><><<v^<<<v^<^^><v^>v^^vv<v^<>>vv^<^v<>^v>>v^v>v<^^vv><>^v<<>v^<>v^>>v>vvv<^><><^^>^vv^>>v^>^<^^<><>><<>^^^><^v^v><<<><<^v^vv>v>><^>>><v^>v<v><><v^v<>v^^>>v<<>v>v<v<v<^^<><>v^^<>>v<^v<v>v<><v<v>^<<>v>vv^^<>>^^^<>^^>^v>v>>>^v^v><v^^<><v>^^v^v<^<^^><<v<^<^<>^<>><<>^>>^>^^><v><>v<><>><<<>>>>vv>>>^>>^v<^>v^^^v<<vv>><<<^<<<>>>>>^>vv<^v^<>^<v^>^v><v>vvv<>>>^v^^^v<<<<>>^^<vv<^<^^>^<>v<^<<<>><>>v<^<>^<vvv<^<>><><<v>^^^>^^<<v<v^>^^v^>><<^vv><v>^v>>^<v>v>^^>^v>^vvv<>v^v^^<><vv>vv^>>><>v<^><v<v^<><<<>^v>^v<<<^>^>^>v^v<<><vvv<<v^^<><v>^>>><vv>><v>>v^<vv>>vv<<^v^v<<><^v<vv>>>vv<>>>>^vv>v^<>vv>v^v<v^><v<^^^^^>vv<><<vvv^<v><^<vv><^^^vv^<>^^^^<^><^<>v^<v^v<<^v<<^^<>>^<v^^>>>vv<vvv<>v<<>><^vvv^<<^^<<>>>^<>>>v^^><>><<>><v^v>>>>>><>>><v^<<vvv^>v<>>v^<>vv<><^^^^v^<<^<v^vv><<^^>v<^vvv^v>>v>^>>v>^^><<v^<>v<>vv<^v^vv><v><<vv^v>>v^>>v<^^^>^><<v<>^><>v>>>vvv<v<vv<^>>^v<v>^<^^^^^v><>v><>v^v^v<v^vv^v>vvvv<>vv<<<vv<v<<>^<^>^^v^<<>^<v><^><v<v<><<>v^<<^<><vv>v<<^v>>^v<><v>^>>^^><>v^<^<vvv^>^>^<<<<>vv>^v^v<^^^<vv>><>^^<<v<^<^^>>>v^v<<^^^<v<v<^<>^v<v><v^vv^^v^^v^^<vv<>^<><vv^<^v^<<^><<vvv>^^<^^^<^v>^>^vv><<<^v<v>vv>v<>v^v<v^>v^>>>v^v<>^v<<>^vv>v>v>v^<^>v^^<^>^^^^vv>^^><^>vv^>>^^v>><<<<^><>v<>^<v<vv^>^^><<^><v>v^>^^<^>>><>><v^v<v^<v<vv^v^<<^<vvv>>><vv<^^>>^>^><<v^<>>v>v^v^^><<>vv^v>v^<v><^<>^^<^>v>^<><<<v>^<^<^>^>^>^^v^<<^^v^^<^<>><^>v>>^^<>^^^<<<<v^>^v<^vv>^<<<v<><<v<>vv>>>v><>>><>>v<<<vv><>^v>v<^>><^><><v<>^v^>^v>^v<<><<^<>>v>^><>^>><>><^<v^><v^^<><v><^^>^v^^<>v^<v^<^v<v^^^^^v^<<^>^^^<^v><>^^<<<><<<<<^^>v^vvvv>v<>>vv<^>^v^>v<^vv^v<<><<v>v^v>^^><><^<v^>v><vv><>>><<>^vv<>v>>v<^v>>>v<v>v>v>^vv<<>^^vv<v<^v^<v<v>vv<>^<^<vv<v^<^v^^><<>^>><^v>vv^^v<<^^><<>v^^<><><v^^<v^v>^>^>^>v<^<v>^v^^>v<>vvv<^v<v^v><<v^><<^^><^<<v^v^>v<>^>v><><v>^<v<v>^<^^^>^v<<><<><>vv>v^<>v^><v^v<v><><<v>v<vv><<v>>v>^<<<>vv>>vvv>^^vv^v^^<^^<>v^^<>v>>^^>^>^>v>><^>><>>^<<>><^>v<<<<<<<^v^v<v^<v^^>^<><<v<^>v^>v^vv<<^^vv^>>>>^<>v<^v<>v<vv<^>>v^vv>vv><vv<<^>v>><vv>>>vv^<<<<vv^>v<<<<^^>^^v^><<^<v^>v^>^^<v<>vvv^>^<>vvv<v<^^>v^<<v>><>v<v<>^^<vvv>^>vv><><<<^^vv<v^<v<>v<>><<v><^vv^>^<^>^^^<<<v>vv^<^<<>^>^<vv>v><v<<^><^>^^<vv^v^^>>>>vv^><^^vv><>^<v^v>v<vv>v><<<v>v<v>^><v^^><v>v<^v^>>^^<v^>^^>vv>>vv^><^vv^vv<<^>vv>^v<v><vv><v<vvvvv>^^v^v><v>>>^vv<>v>^^^^<^>><>^v^^^>v<^^<<^^v<vv<>vvv<^>><><^>>^><^<>v<v<<><<v><v^v<>><^>v><<v^<v>v<^<vv^v^v^>vvv^^>v>^<vv^>v^v^<>v>^>>vv>><^^<v<<>^vv<><><<^v<v>v<<vv><>><^v<v>>v^>vvv^v^<<^><v<>^vv^>v^<v<^>>v<v><v><v>>^<<<v^<><<>v>^>^^<v<>>^<>^>^><<<^<<^<<^>^v>>><vvv>><<<<v>>>>>>>^<^v<^>v<>vv<><>v>>^>>^>vv^^><<^<v<v>>^^<<^>v<^>>vv>^<>v><^>v<vv>>>>>>^v<^<<<v^><vv<<>>vv<<><v<><<<v<^<v<>>v<^^^^v^^<^^^<^<vv><<^>><>v<<>v<v<>>>><>v^vv>^>^>>vv^v<v<<><^v>vv^><v<<>v^v<^>vv<<^^v><^>>^^vv<^<>>v^^>><v>^v>>>^>>v>v<>v<^vv><>^<<^>vv>>><><>v^><>v^>v>v><^v<><v<v>^v<<^vv^><^^>><^^^<<<^>v>^v>>><^>><^>>>^^^<^>vv<><<<v^>^<^^>>^^^v^v^v>v<v>>>><^>>>v>^vv<<^^^<^^vv>v<<><v<<^^>v>><<v^^><^>^<^>^v^>v><^<^vv>v>><>^<<vv<<v>v<vv<v>^>^>><^^<v>^v^v<><<>vvv<^<v>^><>^>vvv>>>^><<>><v^^<^<<^v>>^v<v<vv>vv^v^>v<<vvv<^^v^v>^<^>>^>v<^>^v<<><<<^>^<^^^>vv<^^^^vv<v<^^v<<<<v<^v^<><v<<^><<>vv>>><^<^<>>>^>^>>^<<<<<^^v>^>^<>vvv^^<^><^>^^v>^vv^><v^<^<<v^<vvv<<^v<><^><^>>>v>^v>^>^v<vv^v>><v><^><v^^>v^>^<><<><>v<v^>vvv^>^>>v<>^><^>^><vvv>^^v^v>v<>^v^><^>>v>v^><<<^>>^<>^<>>v><>>v^>^>^^<>>v^>^<vvvv<^vvvv^>>vv^<v^v>^vv<>v<>^<v<v>v>^^><^>vv^<^v^<<^<^<><vv<^v<^v><>>>^v^<<^><^>vv<v>v<^>vv^>v<<<>^<><v<^^^>v><^^<>^<^<v^vv^<<^>><<v^v<^vvv<<<>>vvvv^v^^^>v<>>><<>vvv<<^^^>v>v>>v<<v<v^v^>^^v>^><^<><<v^<v<v^^^><>v^^^<v>vv<>^>^^vv>^<<^v<^v><v>>>^>>><^<<>^v>>^>vv<<<v<>^<v><v^<^<>v>v^^v^>><<^v<<<<>v>v>v^^<^><>^^<<<v>vv<>>>^>>v<><v^>^<><vv>v>v^v<v^<^>>^>><<^^<^^v<vv<>><<<v<^<<^^^>vvv^<vvv<^>vv><>><<<^<v^v^^<<^vvv^^<^<><<>^<^<>>vvv<>^<>v^v<><>>v^v><<>>>vvv>v<>^>>^><^>vv<<>>v<<^><>v>>^^<v>^>^<<>><^<<vv<^<vv^vv><>>>><^<v>^>vv<v><>^<>vvvvv^vv<<v<>>>^<<><>^^vvv>>>vv<<^^><^v^^v<>^^>^><^>v^^^^v<^<<vv<vv<>vv^^>v^vv>v><>>vv>^<^<v^v^>>v^v^^v>^>vv^>v<vvvv<^v<^v>^v>^^v<<^>^^<<>^><^v>>>vv^>^^>vvvv>>v<^<v>^>>>v^<><^<^^<v>vv^^><v>v^<>^^^>>><^^v>v>^<<>^<v^>vvv^>^^^><v<^>>v<v>>^v><<><<>v<^<<>^><>^>vv>^<v>^^v<<^v^vvv^^>^vv^<^>^>^^v>v^>^<<><<^>v>>vv^vv><v>>^<<^<v^^<^<v^^vv^><^^<^^><v^^>v^^^<^<>^<>>^v<^vvv^^v^<><^>>>>>v><><<<>vv<^v>><<>vvv<><<vv<<<^>v^^>>^>^v>><><^^v<>><>>v^>^<vv><<<>><><<v>^^<>>v<><^<vv>vv<^v>^<<<<v<^<<^^>>^<><^>><<>^>v>^^^v>>^<^^v><v^v>^><<><>>^>>^<<v<>^v<>^>^<v>>vv>^vvv<<v<<^>^>^<<^^<>^^^^vvv<>^vv<vvvvv^^>^^<^>>><>v^<><^<<^>v^^v<>>^vv<>v^^<>>v^vvvvv<<v^<v^^>>><vvvvv>><^>vv>v^v^<v<^>^^><^>^^^^v<><^v<<>v^>v>>vv<<>^<v^^>vvv>^^<v^<>vv^><>><v^^v<>^>>^>v><>>^^v>^>^>>>^>v<^v>v>^<^^^^^>>v<v<>>v<<^>^<v<<>^^>><<^><>v<>^^^vv<>^^>><<^^>v>vv>vv>v^>^v>v^^<>>><<v><v<<>>v><>vvv^^v>^^>^vvvv^>^<>^vvvv><v><v<>>><>^<^vv<>^v<^v<>^vvv<<>><vvv^>>^><<vv^<v^>^<v<<^^>^^<^^v^>v<>v^v><>><v^^>>^vvv><^vv>v^<^<^v>>v^^>^vvv^<v^^v^^>v<^<>>^<>>>^^<><^^vv<>^vv^<>>>>^^<<^^<>vv^^><>^^<v<<v>^<v^^>^v<><><>vvv>^v^>>vv<<^v<<>><v>^><^>>>^<^<^^>vv^<<^<>>^^><><<v>^^<v>>v<<vvvv>^v^vv>><^^<<^>>v>v<^^^<^><^^vv>^vv<^<vv<>v><^<><v><^^^>>^<><^<v>>>>v^<v>>>>>v<><^^>v<^<^>><v<>^>vv>^^v^v^<<v<><<<^v^><<^<><<<<v<^>><<<>v>>vv><vv<><<^<^<><vv>^^^^<>v<<<<v>vv<>vv^^^>><>vv^><>>^vv<<><^^vv<>v^>>^<<>^<v^<^>v<`;
const DAY4 = `yzbqklnj`;
const DAY5 = `zgsnvdmlfuplrubt
vlhagaovgqjmgvwq
ffumlmqwfcsyqpss
zztdcqzqddaazdjp
eavfzjajkjesnlsb
...
phdqqxleqdjfgfbg
cqfikbgxvjmnfncy`;
const DAY6 = `turn on 489,959 through 759,964
...
k AND m -> n
as RSHIFT 2 -> at`;
const DAY8 = ((s) => s.raw)`"sjdivfriyaaqa\xd2v\"k\"mpcu\"yyu\"en"
"vcqc"
...
"ccxjgiocmuhf\"ycnh"
"lltj\"kbbxi"`[0];
const DAY9 = `AlphaCentauri to Snowdin = 66
...
const DAY10 = `1113222113`;
const DAY11 = `hepxcrrq`;
const DAY12 = {
  e: [
    [
      {
  ...
  c: [
    {
      ...
      a: {
        ...
        c: {
          ...
          j: [
            ...
            186,
            175,
            { e: 29, a: 150, d: 'green', c: 129, h: 138, b: -29, g: 7, f: 'red', i: 'violet' },
          ],
          c: 'yellow',
          h: [
            'blue',
        ...
        f: {
          c: {
            e: -28,
            c: ['red', 'violet', 'blue', 'orange', 'yellow', 'violet', -30, 134, 0],
            a: -37,
            b: 41,
            d: 143,
          },
      ...
      d: {
        ...
        j: 'violet',
        c: [
          { e: 'violet', a: 'orange', d: 'violet', c: -36, h: 68, b: 195, g: 41, f: 63 },
          11,
          -20,
          {
            e: [100, 43, 183],
            a: 'yellow',
            d: ['orange', 'yellow', 'violet', 'yellow', 143, 162, -23, 168, 145, -33],
            j: 80,
            c: 'orange',
            h: { a: 'orange' },
            b: 'violet',
        ...
        h: [
          ...
          { a: { e: 178, c: 'blue', a: -2, g: 99, b: 'orange', d: -34, f: 'green' } },
          'blue',
        ],
        b: 'violet',
        ...
        i: {
          e: [
            'orange',
            -16,
            ['violet', 63, 'blue', -40, 119, 22, 'orange', 'orange', 'violet', 'green'],
            -30,
            { e: 'yellow', c: 172, a: 'green', g: 'yellow', b: 'green', d: 'yellow', f: 'red' },
            190,
            28,
    ...
    },
    {
      e: [
        ...
        [
          156,
          'red',
          { c: 7, a: [152, 107, 130], b: { c: 'yellow', a: 114, b: 38, d: 'blue' }, d: 'orange' },
          { a: 49, b: -34 },
          34,
          -32,
          'green',
      ...
      b: [
        ...
        -14,
        {
          e: 37,
          a: 86,
          d: { e: 186, a: -25, d: 71, c: 'orange', h: 86, b: 113, g: 27, f: 'green', i: 'yellow' },
          c: 16,
          h: 'orange',
          b: 'green',
          g: [
            ...
            ['orange', 131, 'red', 'blue', 'orange', 183, 82, 'orange', 'yellow', 'blue'],
            49,
            'orange',
            'violet',
            'violet',
        ...
        [
          ...
          [
            ...
            'orange',
            135,
            { e: 'green', c: 141, a: -11, b: 129, d: 'orange', f: 'green' },
            'violet',
          ],
          14,
          [
        ...
        'green',
        {
          ...
          d: -8,
          j: -47,
          c: { e: 'orange', c: 74, a: 'yellow', b: 'orange', d: 34, f: 124 },
          h: 152,
          b: 'red',
          g: 'yellow',
          f: 161,
      ...
      g: [
        ...
        [
          ...
          [
            ...
            'orange',
            -40,
            ['green', 'orange', 'yellow', 187, 3, 'yellow', 'violet', 'orange', 195, 'yellow'],
            'blue',
            'yellow',
            'blue',
          ],
        ...
        { c: 'red', a: 24, b: 139 },
        {
          ...
          d: 43,
          c: 143,
          h: ['violet', 'yellow', 'green', 159, 165, { a: 'blue', b: 'violet' }],
          b: 150,
      ...
      f: {
        e: {
          e: 39,
          a: 'orange',
          d: { e: [11], c: 'violet', a: 'orange', g: 49, b: 'red', d: 0, f: { a: 45 } },
          c: 'violet',
          h: -30,
          b: [
            93,
      ...
      e: {
        e: [
          ...
          [
            ...
            -20,
            97,
            { e: 108, c: 195, a: 'blue', g: 51, b: 'green', d: 'violet', f: 28 },
          ],
        ],
        a: 'green',
        d: 164,
        ...
        h: 'orange',
        b: 'green',
        g: { e: 'red', c: 151, a: 'violet', b: 46, d: 'yellow', f: ['red'] },
        f: -35,
        i: 'orange',
      },
      a: {
        ...
        c: {
          ...
          b: [
            -5,
            ['violet', 'blue', 'orange', 'violet', 3, 'yellow', 86, 'orange', 197, 51],
            6,
            156,
            43,
            94,
    ...
    153,
    {
      a: {
        ...
        a: [
          {
            ...
            d: 'green',
            c: 'violet',
            h: { e: 'blue', c: 62, a: 148, g: 'violet', b: 6, d: 'yellow', f: -1 },
            b: 'yellow',
            g: -14,
            f: 58,
          },
          ...
          [
            'orange',
            { e: 148, c: 'red', a: 85, g: 62, b: -13, d: -25, f: 'orange' },
            -47,
            34,
        ...
        j: [
          ...
          'yellow',
          155,
          { e: -28, c: 'violet', a: { a: 'green', b: 3 }, b: 'red', d: -16 },
        ],
        c: ['violet', -16],
        h: 'blue',
        b: 'green',
        g: [
          ...
          50,
          36,
          { e: 'green', a: 162, d: 112, c: 166, h: 92, b: 31, g: 'blue', f: -12 },
        ],
        f: 'yellow',
        i: [
          'yellow',
      ...
      d: {
        e: {
          ...
          d: [
            ...
            'red',
            'violet',
            { e: -18, a: 'yellow', d: 'red', c: 0, h: 'yellow', b: 'yellow', g: 6, f: 'yellow' },
            162,
          ],
        },
        c: -6,
    ...
    c: [
      ...
      [
        12,
        {
          e: 'blue',
          c: 162,
          a: ['blue', 184, 'yellow', 'orange', { a: 'yellow', b: 'green' }, 88, -19, 60, 'yellow'],
          g: 'yellow',
          b: 191,
          d: -6,
          f: 'violet',
      ...
      ],
      {
        ...
        b: {
          ...
          b: [
            ...
            'orange',
            'violet',
            { e: 'red', a: 'red', d: 163, c: 153, h: 'green', b: 6, g: 'blue', f: 17, i: 63 },
            163,
      ...
      b: [
        'violet',
        {
          e: {
            ...
            c: 136,
            h: 90,
            b: { e: 26, c: 'green', a: 'blue', g: 'violet', b: 192, d: 198, f: 86 },
            g: 'orange',
            f: 'blue',
          },
          a: 137,
    ...
    d: {
      ...
      b: {
        ...
        b: [
          ...
          65,
          {
            c: { e: 'violet', c: 'yellow', a: 'violet', b: 'blue', d: 'orange' },
            a: 'red',
            b: 176,
          },
          192,
  ...
  b: [
    ...
    [
      [
        ...
        ['orange', [166], 'violet'],
        {
          ...
          a: [
            ...
            'violet',
            'orange',
            ['violet', 'yellow', 'blue', 107, 24, -1, 'orange', 13, 'green', 'violet'],
          ],
          b: 'violet',
          d: 107,
        },
        ...
        ['yellow', -22, [177, 69, 144, 84, 159, 'violet'], 'green'],
        {
          ...
          f: 'orange',
          i: [
            { e: 186, c: 'orange', a: 'green', b: 174, d: 'yellow', f: 46 },
            'violet',
            188,
            'yellow',
            54,
        ...
        [
          ...
          ],
          {
            ...
            c: 'yellow',
            h: 'yellow',
            b: { e: 91, a: 161, d: -44, c: -45, h: 'blue', b: 'orange', g: 122, f: 'orange' },
            g: 'yellow',
            f: 'blue',
          },
          139,
      ...
      [
        ...
        'red',
        {
          e: 192,
          c: 92,
          a: { a: ['red', 164, 'yellow', 189, 'blue', 150, 'green', 'violet', -35, 33], b: 'red' },
          g: 'yellow',
          b: { a: 'blue' },
          d: 'red',
          f: -31,
        ...
        'red',
        [
          ['green', 'green', 42, -47, [88, 142, 'blue', 59, -42, 'violet'], 'green'],
          'orange',
          ['violet', 'yellow', 'violet', 198, 94, 44, 'orange', 'green', 'blue', 26],
          'blue',
          'violet',
        ],
      ],
    ...
    ],
    {
      ...
      a: {
        ...
        c: 'violet',
        a: [
          [127, -18, -4, [-40, 42, 'violet', 167, 'orange', 112, 'orange'], 30, 31, 'violet', 37],
      ...
      f: [
        ...
        [
          'green',
          { e: 'red', c: 'yellow', a: 10, g: 'blue', b: 56, d: 'red', f: ['green', 'red', 'red'] },
          ['violet', 'orange', { e: 7, c: 170, a: 'green', b: 55, d: 115 }, 'green', 'blue'],
        ],
      ],
    },
    {
      ...
      f: {
        ...
        c: [
          { a: 'orange', b: 179 },
          'red',
          { e: 'violet', c: 'orange', a: 'blue', g: 'violet', b: 25, d: 149, f: -27 },
          {
            e: 'green',
            a: 'yellow',
            d: 'violet',
  ...
  d: [
    [
      [
        ...
        [
          ...
          21,
          {
            ...
            g: 'orange',
            b: 60,
            d: { e: 'yellow', c: 'green', a: 'yellow', g: 'violet', b: 134, d: 149, f: 'yellow' },
            f: 'blue',
          },
          'violet',
          [66, 'green', 25, 106, 'red', 'orange'],
          {
            a: { e: 'orange', a: 95, d: 'red', c: 176, h: 179, b: 87, g: 195, f: 71, i: 'violet' },
            b: 14,
          },
          55,
        ],
      ...
      [
        ...
        { a: -23, b: 'violet' },
        [7],
        [101, 181, 'yellow', { e: 'violet', c: 'green', a: 56, b: 'green', d: 175 }],
      ],
      'violet',
      {
        c: 'green',
        ...
        b: [
          'orange',
          { e: 62, c: 'violet', a: -5, b: 39, d: [122, 129, 'violet', 'orange'] },
          'green',
        ],
      },
    ],
    ...
    e: {
      e: [
        {
          ...
          b: [
            ...
            'blue',
            26,
            { e: 'violet', c: 'green', a: 64, g: 36, b: 'blue', d: 'blue', f: 'green' },
            'violet',
            125,
            'orange',
          ],
        ...
        'yellow',
        {
          c: { e: -46, c: 121, a: 191, g: 'blue', b: 67, d: -25, f: 'blue' },
          a: 'orange',
          b: { a: 108, b: ['red', -48] },
        },
        {
          ...
          b: 'yellow',
          d: 37,
          f: { e: -3, a: 105, d: 'red', c: 'red', h: 'green', b: 27, g: 189, f: 'violet' },
        },
        'red',
        [
          'yellow',
          152,
          {
            ...
            d: 79,
            c: 'violet',
            h: { e: 'blue', c: 53, a: 'orange', b: -43, d: 'violet', f: 'orange' },
            b: 32,
            g: 'green',
            f: 'green',
            i: 23,
      ...
      a: {
        e: {
          e: 'green',
          a: 'yellow',
          d: { c: -48, a: ['violet', 195, 77, -13, 'green', 'red'], b: 'blue', d: 'red' },
          c: 'violet',
          h: [-13, 'green'],
          b: 27,
          g: -37,
      ...
      c: [
        ...
        135,
        {
          ...
          f: { e: 'blue', c: 174, a: 187, g: 'violet', b: 36, d: 80, f: 188 },
          i: -10,
        },
        60,
        'orange',
        ...
        },
        {
          ...
          c: {
            ...
            a: -22,
            b: 3,
            d: { e: 185, c: 52, a: 'yellow', b: 165, d: 'blue', f: 'yellow' },
          },
          a: 45,
          b: 'green',
          d: 'blue',
      ...
      f: [162, { c: [-30, 'violet'], a: 'blue', b: 'blue', d: 83 }, 'blue'],
      i: 'green',
    },
    a: [
      'blue',
        ...
        a: [
          {
            ...
            b: 'yellow',
            d: { e: 'violet', c: 'violet', a: 'orange', b: 189, d: 21, f: 71 },
            f: 15,
          },
          'green',
          150,
      ...
      [
        ...
        [194, 146, 'green', 90, 'violet', 'violet', -5, 'red'],
        {
          ...
          d: {
            ...
            c: 94,
            h: { e: 'red', c: 'blue', a: 89, g: 197, b: 148, d: 91, f: 52 },
            b: 'orange',
            g: 'red',
            f: 'green',
          },
    ...
    d: {
      ...
      b: {
        ...
        g: {
          ...
          a: 'green',
          g: 1,
          b: [{ a: 100, b: 'yellow' }, 63, 41, 168, 152, 'yellow', 198, -14, 30, 103],
          d: 'violet',
    ...
    j: {
      ...
      b: [
        14,
        {
          ...
          d: 58,
          c: 'violet',
          h: { a: { e: 27, a: 'orange', d: 181, c: 142, h: 195, b: 'yellow', g: 44, f: 'yellow' } },
          b: -14,
          g: 'red',
          f: { a: 154 },
          i: 90,
        ...
        [
          ...
          [
            'blue',
            { e: 'blue', c: -6, a: 'green', b: 'green', d: 'green', f: 50 },
            -44,
            {
              e: 'violet',
              a: 'yellow',
      ...
      g: {
        ...
        c: [
          ...
          'blue',
          { e: 73, a: 40, d: 'green', c: 'red', h: 'yellow', b: 117, g: 178, f: 170 },
          'yellow',
          188,
        ],
        h: { a: -21 },
        b: {
          ...
          b: [
            ['green', 'yellow', 2, 'violet', -30, 'yellow', 'red', -40, 'orange', 'violet'],
            'red',
            58,
            165,
            'red',
      ...
      i: [
        [
          ...
          'yellow',
          'red',
          { e: -5, c: 124, a: 'yellow', g: 'violet', b: 'orange', d: 'violet', f: 149 },
          -16,
          9,
        ],
        'violet',
...
const DAY13 = `Alice would lose 2 happiness units by sitting next to Bob.
...
const DAY14 = `Vixen can fly 8 km/s for 8 seconds, but then must rest for 53 seconds.
...
const DAY16 = `Sue 1: goldfish: 9, cars: 0, samoyeds: 9
...
const DAY20 = 29000000;
const DAY21 = `Hit Points: 100
Damage: 8
Armor: 2`;
const DAY22 = ``;
const DAY23 = ``;
